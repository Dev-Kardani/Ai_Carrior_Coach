...
/// Signup screen with premium Figma-inspired design
...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _handleSignup() async {
    DebugLogger.info('AUTH_UI', 'SIGNUP_BUTTON_CLICKED');
    if (!_formKey.currentState!.validate()) {
      DebugLogger.warning(
          'AUTH_UI', 'VALIDATION_FAILED', 'Signup form validation failed');
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        DebugLogger.success('AUTH_UI', 'SIGNUP_SUCCESS',
            'User created, navigating to profile setup');
        ErrorHandler.showSuccess(
            context, 'Account created! Let\'s set up your profile.');
        Navigator.of(context).pushReplacementNamed('/auth/setup');
      }
    } catch (e) {
      if (mounted) {
        DebugLogger.failed('AUTH_UI', 'SIGNUP_FAILED', e.toString(), error: e);
